...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(KC_TRANSPARENT,KC_1,KC_2,KC_3,KC_4,KC_5,KC_LEFT,KC_TRANSPARENT,KC_Q,KC_W,KC_E,KC_R,KC_T,ALL_T(KC_NO),KC_DELETE,LT(2,KC_A),KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_BSPACE,MO(1),KC_TRANSPARENT,LALT(KC_LSHIFT),KC_LCTL,OSL(1),KC_TRANSPARENT,KC_LGUI,KC_ESCAPE,KC_LSHIFT,KC_BSPACE,KC_TAB,KC_RIGHT,KC_6,KC_7,KC_8,KC_9,KC_0,KC_TRANSPARENT,ALL_T(KC_NO),KC_Y,KC_U,KC_I,KC_O,KC_P,KC_TRANSPARENT,KC_H,KC_J,KC_K,KC_L,LT(2,KC_SCOLON),KC_TRANSPARENT,KC_ENTER,KC_N,KC_M,KC_COMMA,KC_DOT,KC_SLASH,KC_LSHIFT,OSL(2),KC_LALT,KC_TRANSPARENT,KC_TRANSPARENT,MO(2),KC_LALT,KC_TRANSPARENT,KC_PGUP,KC_ENTER,KC_LGUI,KC_SPACE),
  ...
  [2] = KEYMAP(KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TILD,KC_HOME,KC_UP,KC_END,KC_PGUP,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_LEFT,KC_DOWN,KC_RIGHT,KC_PGDOWN,KC_TRANSPARENT,KC_GRAVE,KC_TRANSPARENT,KC_TRANSPARENT,KC_PIPE,KC_BSLASH,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_EQUAL,KC_PLUS,KC_LCBR,KC_RCBR,KC_TRANSPARENT,KC_TRANSPARENT,LSFT(KC_NO),LSFT(KC_SLASH),KC_MINUS,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_QUOTE,KC_UNDS,KC_LBRACKET,KC_RBRACKET,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT),
