...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = KEYMAP(KC_TRANSPARENT,KC_F20,KC_F21,KC_F22,KC_F23,KC_F24,KC_TRANSPARENT,LGUI(KC_LBRACKET),KC_X,LALT(KC_LEFT),LALT(KC_RIGHT),KC_X,LGUI(KC_F),KC_TRANSPARENT,LGUI(KC_RBRACKET),LSFT(KC_LEFT),KC_LEFT,KC_RIGHT,LSFT(KC_RIGHT),LGUI(KC_G),KC_TRANSPARENT,KC_X,LGUI(KC_LEFT),LGUI(KC_RIGHT),KC_X,LGUI(KC_E),KC_TRANSPARENT,KC_TRANSPARENT,KC_UNDO,KC_CUT,KC_COPY,KC_PASTE,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT),
